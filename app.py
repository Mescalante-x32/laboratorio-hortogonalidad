...
tema = st.sidebar.radio(
    ...
    ("1. Ortogonalidad de Señales", "2. Valores RMS y Promedio", "3. Evaluación de Conceptos")
)
...
if tema == "1. Ortogonalidad de Señales":
    ...
    with col_graph:
        ...
        st.download_button("📥 Descargar Datos Completos (v, i, p)", csv_m1, "ortogonalidad.csv", "text/csv")
...
# ==========================================
    ...
    st.download_button(f"📥 Descargar Datos de {tipo_onda}", csv_m2, "analisis_rms.csv", "text/csv")
...
# ==========================================
    ...
    with st.form("examen"):
        ...
        if enviado:
            ...
            st.write(f"Pregunta 1: {res1}")
            st.write(f"Pregunta 2: {res2}")
